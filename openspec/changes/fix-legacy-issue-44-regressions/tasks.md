...
- [x] 5.3 Thread the chosen collection through imports: `build_learning_item` in `src-tauri/src/study_json_import.rs` (`:185,255-301`); audit `anki.rs` and `supermemo_import.rs` for the same pattern and fix identically
