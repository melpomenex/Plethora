...
### Requirement: Element types follow the SuperMemo taxonomy

The `element_type` column SHALL use the SuperMemo type byte: 0 = Topic, 1 =
...
the parent's child pointer), mirroring SuperMemo's symmetric doubly-linked
