...
> This capability is SuperMemo's **neural queue** — the optional "Go neural"
...
The neural queue SHALL be an opt-in review mode (SuperMemo's *Learn : Go
...
priority-queue position yet. This matches SuperMemo's `FUN_00c18110`
