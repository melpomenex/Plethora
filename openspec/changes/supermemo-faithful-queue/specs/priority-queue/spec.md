...
> This capability is SuperMemo's **priority queue** — the backbone of normal
...
queue treats topics and items uniformly, as SuperMemo does.
...
SuperMemo's `FUN_00cb1630` and `FUN_00cb21c0`.
...
same order. This mirrors SuperMemo's documented sorting behavior and the
...
the reverse-engineered algorithm in `~sushi/sm20-re/postpone_algorithm.md`.
