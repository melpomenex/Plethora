...
export function EditExtractDialog({
  extract,
  isOpen,
  onClose,
  onUpdate,
}: EditExtractDialogProps) {
  ...
  const [highlightColor, setHighlightColor] = useState(extract.highlight_color || HIGHLIGHT_COLORS[0].value);
