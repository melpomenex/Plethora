...
export const DEFAULT_SHORTCUTS: ShortcutAction[] = [
  ...
  // Vim Reading Mode
  {
    ...
    description: "Activate/deactivate vim reading mode (Escape when no modal is open)",
    category: ShortcutCategory.VimReading,
  ...
  },
  {
    id: "vim.0",
    name: "Line Start",
    description: "Move to start of current line",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "0" },
  },
  {
  ...
  },
  {
    id: "vim.gg",
    name: "Document Start",
    description: "Jump to first word of document",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "gg" },
  },
  {
    id: "vim.G",
    name: "Document End",
    description: "Jump to last word of document",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "G", shift: true },
  },
  {
    id: "vim.open-brace",
    name: "Previous Paragraph",
    description: "Jump to start of previous paragraph",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "{" },
  },
  {
    id: "vim.close-brace",
    name: "Next Paragraph",
    description: "Jump to start of next paragraph",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "}" },
  },
  {
  ...
  },
  {
    ...
    description: "Enter visual line selection mode",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "V", shift: true },
  },
  {
    id: "vim.extract",
    name: "Extract Selection",
    description: "Create instant extract from selected text",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "Enter" },
  },
  {
    id: "vim.extract-dialog",
    name: "Extract with Dialog",
    description: "Open extract dialog for selected text",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "E", shift: true },
  },
  {
    id: "vim.yank",
    name: "Yank (Copy)",
  ...
  },
  {
    ...
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "F", shift: true },
  },
  {
    id: "vim.W",
    name: "WORD Forward",
    description: "Move to start of next WORD (whitespace-delimited)",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "W", shift: true },
  },
  {
    id: "vim.B",
    name: "WORD Back",
  ...
  },
  {
    ...
    description: "Select the word (and trailing space)",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "aw" },
  },
  {
    ...
    description: "Select the inner word",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "iw" },
  },
  {
    id: "vim.as",
    name: "Select Around Sentence",
    description: "Select the sentence (and trailing space)",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "as" },
  },
  {
    id: "vim.is",
    name: "Select Inner Sentence",
    description: "Select the inner sentence",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "is" },
  },
  {
    id: "vim.ap",
    name: "Select Around Paragraph",
    description: "Select the paragraph (and trailing blank line)",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "ap" },
  },
  {
    ...
    description: "Select the inner paragraph",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "ip" },
  },
  {
    id: "vim.d",
    name: "Operator: Extract",
    description: "Extract over the next motion/text object (e.g. daw, dd)",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "d" },
  },
  {
    id: "vim.c",
    name: "Operator: Change (Extract Dialog)",
    description: "Open the extract dialog over the next motion/text object",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "c" },
  },
  {
    id: "vim.gf",
    name: "Chain to Flashcard",
    description: "Open Flashcard Studio seeded from the last extract",
    category: ShortcutCategory.VimReading,
    defaultCombo: { key: "gf" },
  },
];
