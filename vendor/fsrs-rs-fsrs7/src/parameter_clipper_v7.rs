...
pub(crate) fn clip_fsrs7_parameters(parameters: &mut [f32]) {
    ...
    parameters[11] = clamp_safe(parameters[11], 0.1, 1.0);
    parameters[12] = clamp_safe(parameters[12], 0.0, 3.5);
    parameters[13] = clamp_safe(parameters[13], 0.0, 1.0);
    parameters[14] = clamp_safe(parameters[14], 1.0, 7.0);

    parameters[15] = clamp_safe(parameters[15], 0.0, 4.0);
    parameters[16] = clamp_safe(parameters[16], 0.0, 2.0);
    parameters[17] = clamp_safe(parameters[17], 0.5, 6.0);
    parameters[18] = clamp_safe(parameters[18], 0.001, 1.5);
    parameters[19] = clamp_safe(parameters[19], 0.001, 1.0);
    parameters[20] = clamp_safe(parameters[20], 0.0, 5.0);
    parameters[21] = clamp_safe(parameters[21], 0.0, 1.0);
    parameters[22] = clamp_safe(parameters[22], 1.0, 7.0);
    ...
    parameters[30] = clamp_safe(parameters[30], 0.1, 1.1);
    parameters[31] = clamp_safe(parameters[31], 0.0, 1.0);
    parameters[32] = clamp_safe(parameters[32], 0.0, 0.6);
    parameters[33] = clamp_safe(parameters[33], 0.0, 0.6);
}
