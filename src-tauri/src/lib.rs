...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::upsert_synced_extract,
            commands::delete_synced_extract,
            commands::get_synced_extract,
            commands::upsert_synced_collection,
            commands::delete_synced_collection,
            commands::get_synced_collection,
            commands::upsert_synced_file_manifest,
            commands::delete_synced_file_manifest,
            commands::get_file_manifest_entries,
            commands::enqueue_sync_outbox,
            commands::get_sync_outbox,
            commands::mark_sync_outbox_sent,
            commands::record_sync_inbox,
            commands::get_pending_sync_inbox,
            commands::mark_sync_inbox_applied,
            commands::set_sync_checkpoint,
            commands::get_sync_checkpoint,
            commands::set_sync_cutover_state,
            commands::get_sync_cutover_state,
            commands::record_sync_cutover_domain_progress,
            commands::get_sync_cutover_domain_progress,
            commands::count_sync_dead_letters_since,
            commands::dead_letter_sync_operation,
