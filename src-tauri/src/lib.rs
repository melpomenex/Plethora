...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_help_index_summary,
            commands::get_bundled_help_index,
            commands::search_help_docs_native,
            commands::get_documents,
            commands::create_language_profile,
            commands::get_language_profiles,
            commands::get_language_profile,
            commands::update_language_profile,
            commands::archive_language_profile,
            commands::delete_language_profile,
            commands::get_active_language_profile,
            ...
            commands::export_language_profiles,
            commands::import_language_profiles,
            commands::serialize_language_profiles_for_sync,
            commands::apply_language_profiles_sync,
            commands::upsert_language_lexical_entry,
            commands::get_language_lexical_entry,
            commands::list_language_lexical_entries,
            commands::record_language_encounter,
            commands::record_language_encounter_batch,
            commands::list_language_occurrences,
            commands::record_language_lookup,
            commands::migrate_language_lookup_history,
            commands::apply_language_lexical_override,
            commands::export_language_lexicon,
            commands::serialize_language_lexicon_for_sync,
            commands::get_language_knowledge_state,
            commands::resolve_language_knowledge_state,
            commands::set_language_knowledge_state,
            commands::set_language_knowledge_states_batch,
            commands::record_language_knowledge_evidence,
            commands::list_language_knowledge_history,
            commands::undo_language_knowledge_change,
            commands::create_language_memorization_link,
            commands::preview_language_known_word_import,
            commands::import_language_known_words,
            commands::export_language_knowledge,
            commands::upsert_language_practice_attempt,
            commands::get_language_practice_attempt,
            commands::list_language_practice_attempts,
            commands::delete_language_practice_attempt,
            commands::purge_expired_language_practice_attempts,
            commands::export_language_practice_attempts,
            ...
            // Audio Editions and Listening Sessions commands
            commands::create_audio_edition,
            commands::get_audio_edition,
            commands::get_audio_edition_by_document,
            commands::list_audio_editions,
            commands::update_audio_edition_status,
            commands::delete_audio_edition,
            commands::get_audio_edition_section,
            commands::get_audio_edition_sections,
            commands::update_audio_edition_section_status,
            commands::save_audio_edition_anchors,
            commands::get_audio_edition_anchors,
            commands::get_anchors_for_edition,
            commands::find_anchor_by_audio_time,
            commands::find_anchor_by_source,
            commands::create_listening_session,
            commands::get_listening_session,
            commands::get_active_listening_session,
            ...
            transcription::gpu_runtime_status,
            transcription::gpu_runtime_install,
            transcription::gpu_runtime_install_cancel,
            transcription::gpu_runtime_uninstall,
            ...
            models::hf::commands::get_nemotron_asr_catalog_entry,
            models::hf::commands::get_system_info,
            tts::commands::sherpa_tts_status,
            tts::commands::sherpa_tts_load,
