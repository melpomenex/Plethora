...
description: "Native OS window state restoration, system tray icon with quick-study shortcuts, multi-window split panes, and global hotkeys."
category: "platforms-and-devices"
order: 100
published: true
featureStatus: "shipping"
platforms: ["desktop-macos","desktop-windows","desktop-linux"]
keywords: ["system tray","window state","multi window","split panes","desktop app"]
aliases: ["system tray","window state","multi window","split panes","desktop app"]
relatedDocs: ["palette.command_center","platform.battery_saver","settings.themes"]
owner: "E"
claimIds: []
sourcePath: "docs/product/features/platform/desktop-native.md"
---
