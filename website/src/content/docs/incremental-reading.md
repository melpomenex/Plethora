...
description: "Comprehensive guide to the incremental reading methodology, extract formulation, and knowledge distillation in Plethora."
category: "understand-and-extract"
order: 2
published: true
featureStatus: "shipping"
platforms: ["all"]
keywords: ["incremental reading","knowledge distillation","reading workflow"]
aliases: ["incremental reading","knowledge distillation","reading workflow"]
relatedDocs: ["queue.scroll_session","queue.extract_chain","queue.priority_score"]
owner: "E"
claimIds: []
sourcePath: "docs/product/concepts/incremental-reading.md"
---
