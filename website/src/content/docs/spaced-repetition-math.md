...
description: "In-depth mathematical explanation of the Ebbinghaus forgetting curve, Stability, Difficulty, Retrievability, FSRS-6, and Adaptive 3D SInc matrices."
category: "start-here"
order: 100
published: true
featureStatus: "shipping"
platforms: ["all"]
keywords: ["srs math","forgetting curve","stability formula","retrievability equation","fsrs math"]
aliases: ["srs math","forgetting curve","stability formula","retrievability equation","fsrs math"]
relatedDocs: ["scheduler.fsrs","scheduler.adaptive","scheduler.precision.arena"]
owner: "E"
claimIds: []
sourcePath: "docs/product/concepts/spaced-repetition-math.md"
---
