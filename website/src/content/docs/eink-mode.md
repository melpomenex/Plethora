...
description: "Dedicated pure monochrome high-contrast styling (data-display-mode=\"eink\"), zero animations, paginated tap zones, and ghosting mitigation."
category: "platforms-and-devices"
order: 100
published: true
featureStatus: "shipping"
platforms: ["desktop-macos","desktop-windows","desktop-linux","mobile-android","eink"]
keywords: ["eink","e-ink","e-ink mode","eink mode","monochrome mode","high contrast","boox mode","e-paper"]
aliases: ["eink","e-ink","e-ink mode","eink mode","monochrome mode","high contrast","boox mode","e-paper"]
relatedDocs: ["settings.themes","platform.mobile_android","reader.pdf.page_mode"]
owner: "E"
claimIds: []
sourcePath: "docs/product/features/platform/eink-mode.md"
---
