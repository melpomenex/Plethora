...
description: "Automated voice-guided card study where TTS reads question, pauses for configured recall delay, reads answer, and auto-rates."
category: "remember-and-review"
order: 100
published: true
featureStatus: "shipping"
platforms: ["desktop-macos","desktop-windows","desktop-linux","mobile-android","mobile-ios"]
keywords: ["audio review","hands free flashcards","voice review","headphone study"]
aliases: ["audio review","hands free flashcards","voice review","headphone study"]
relatedDocs: ["tts.playback","audio.media_controls","review.flashcard_studio"]
owner: "E"
claimIds: []
sourcePath: "docs/product/features/review/audio-review-mode.md"
---
