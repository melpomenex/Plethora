...
description: "Algorithmic workload smoothing shifting card due dates away from peak days and configuring lower-intensity Easy Days on weekends."
category: "scheduling-and-algorithms"
order: 100
published: true
featureStatus: "shipping"
platforms: ["desktop-macos","desktop-windows","desktop-linux","mobile-android","mobile-ios"]
keywords: ["easy days","load balancing","workload smoothing","daily card cap"]
aliases: ["easy days","load balancing","workload smoothing","daily card cap"]
relatedDocs: ["scheduler.fsrs","scheduler.postpone","queue.scroll_session"]
owner: "E"
claimIds: []
sourcePath: "docs/product/features/scheduling/queue-load-management.md"
---
