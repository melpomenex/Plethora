...
description: "Shared native-media integration for macOS/Linux desktop controls and Android Media3 lock-screen controls, with Windows and iOS capability limits documented explicitly."
category: "start-here"
order: 100
published: true
featureStatus: "shipping"
platforms: ["desktop-macos","desktop-windows","desktop-linux","mobile-android","mobile-ios"]
keywords: ["media keys","now playing","souvlaki","lock screen controls","bluetooth headset"]
aliases: ["media keys","now playing","souvlaki","lock screen controls","bluetooth headset"]
relatedDocs: ["tts.playback","audio.hands_free_study","review.audio_review"]
owner: "E"
claimIds: []
sourcePath: "docs/product/features/tts/media-controls.md"
---
