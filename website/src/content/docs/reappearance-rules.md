...
description: "Algorithmic calculation of document and extract reappearance intervals based on reading speed, text length, priority, and queue load."
category: "understand-and-extract"
order: 100
published: true
featureStatus: "shipping"
platforms: ["desktop-macos","desktop-windows","desktop-linux","mobile-android","mobile-ios"]
keywords: ["article interval","reappearance interval","incremental reading spacing","document scheduling"]
aliases: ["article interval","reappearance interval","incremental reading spacing","document scheduling"]
relatedDocs: ["queue.priority_score","queue.scroll_session","scheduler.fsrs"]
owner: "E"
claimIds: []
sourcePath: "docs/product/features/queue/reappearance-rules.md"
---
