...
| Extension store identity | AMO gecko id `{bb3443c2-dfb8-42a3-8df7-3737a3f80185}`, committed `.xpi` artifacts | **retained-legacy** (AMO listing id is a GUID — the email-style id `incrementum-browser-sync@melpomenex.dev` was never registered on AMO; display name is "Plethora Capture") |
